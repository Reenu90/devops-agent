...
GEMINI_MODEL = "gemini-1.5-flash"   # Fast, generous free tier
...
class DevOpsAgent:
    def __init__(self):
        ...
        # Enable Google Search grounding for up-to-date answers
        self._search_tool = genai.protos.Tool(
    ...
    # ------------------------------------------------------------------ #
    # General chat with web search grounding                              #
    # ------------------------------------------------------------------ #
    ...
    def run_tool(self, prompt: str) -> Generator[str, None, None]:
        """
        Run a specialised tool prompt (command explainer,
        log analyser, runbook generator) — no search grounding needed.
        """
